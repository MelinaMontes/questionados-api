...
public class PreguntaService {
    ...
    public Pregunta buscarPorId(Integer preguntaId) {
    ...
    public List<Pregunta> traer() {
        return repo.findAll();
    }

    public Pregunta crear(String enunciado, Integer categoriaId, List<Respuesta> opciones) {
